...
const About = ({ openWindows, setOpenWindows }) => {
  ...
  const education = [
    { level: "College", institution: "Dhanalakshmi College of Engineering", duration: "2021 - 2025", scored:"7.5 (cgpa)" },
    { level: "SSLC", institution: "C.S. Central Matric Higher Secondary School", duration: "2018 - 2019", scored:"70%" },
    { level: "HSC", institution: "C.S. Central Matric Higher Secondary School", duration: "2019 - 2021", scored:"75% in 11th and 80.6% in 12th" },
  ];
